...
$appContainer = HTML::select(".marketFeatured .app_list.featured .appContainer")->item(0);
...
$privateAppContainer = HTML::select(".marketFeatured .app_list.private .appContainer")->item(0);
if (empty($teamApps))
{
	$privateAppList = HTML::select(".marketFeatured .app_list.private")->item(0);
	HTML::replace($privateAppList, NULL);
}
